...
public class Result {
    ...
    public static double NaiveTesterJOMP_time;

    public static double MovingTesterST_time;
    public static double MovingTesterHJ_time;
    public static double MovingTesterFJP_time;
