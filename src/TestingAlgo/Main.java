...
//        runMovingCircleTesterJvFP(gridFile, events);
    ...
    private static void runNaiveTesterJOMP(GridFile gridFile, ArrayList<Events> events) throws Exception {
        ...
        System.out.println("Total time for naive with JOMP: " + totalTime);
        afterNaive(events);
    }
    ...
    private static void naiveTesterJOMP(GridFile gridFile) throws Exception {
        ...
        long count_naive_circles = naiveJOMP.circle_count;
        ArrayList<Circle> top_likelihood_circles = new ArrayList<>();
        for (int i = 0; i < circles_added; i++) {
            top_likelihood_circles.add(top_likelihood_circles_a[i]);
        }
...
//            }
        ...
        Collections.sort(top_likelihood_circles, Circle.sortByLHR());
        System.out.println("SIZE B");
        System.out.println(lat_circles + " " + lon_circles + " " + assumed_number_of_circles + "asss");
